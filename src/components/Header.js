          ...
          <div className="collapse navbar-collapse" id="navbarsDefault">
            ...
            <ul className="navbar-nav col-md-10 align-items-center">
              ...
              <li className="nav-item ml-2">
                <Link className="navbar-brand" to="/company/profile"><img className="rounded-circle mr-2" src={require("../assets/img/av.png")} alt="Profile" width={30} /><span className="align-middle">Profile</span></Link>
              </li>
              ...
              <li className="nav-item dropdown mr-auto">
                <Link to="#" className="nav-link" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
